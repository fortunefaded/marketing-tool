...
import { FatigueDashboard } from './features/meta-api/components/FatigueDashboard'
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-auto">
          ...
          <Routes>
            ...
            <Route path="/ad-fatigue" element={<FatigueDashboard />} />
            <Route path="/fatigue-education" element={<FatigueDashboard />} />
            <Route path="/test-new-meta-api" element={<NewMetaApiTest />} />
            <Route path="/ad-fatigue-simple" element={<FatigueDashboard />} />
            <Route
              path="/media"
              element={
                <div className="p-6">
