...
export const ECForceOfferAnalysis: React.FC<ECForceOfferAnalysisProps> = ({ orders }) => {
  const offerData = useMemo(() => {
    // オファー別の集計
    const offerStats = orders.reduce(
      (acc, order) => {
    ...
    // 売上順にソート
    return Object.values(offerStats).sort((a: any, b: any) => b.売上 - a.売上)
  }, [orders])
      ...
      <div>
        ...
        <div className="h-64">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              <CartesianGrid strokeDasharray="3 3" />
              <XAxis type="number" tick={{ fontSize: 12 }} tickFormatter={formatYAxis} />
