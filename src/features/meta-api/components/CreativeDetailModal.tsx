              ...
              <Dialog.Panel className="w-full max-w-[80vw] transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all mx-4">
                ...
                <div className="grid grid-cols-3 gap-6">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h5 className="text-lg font-semibold text-gray-900 mb-6 border-b pb-2">広告疲労度分析</h5>
                    ...
                    {/* 個別疲労度スコア - 小さなドーナツを横並び */}
                    <div className="grid grid-cols-3 gap-4">
                      <FatigueDonutChart
                        value={fatigueScores.creativeFatigue}
                        label="クリエイティブの疲労"
                        description="CTR低下による広告コンテンツの陳腐化"
                      ...
                      <FatigueDonutChart
                        ...
                        label="アルゴリズムの疲労"
                        description="CPM上昇によるMeta側の露出制限"
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h6 className="text-lg font-semibold text-gray-900 mb-4 border-b pb-2">広告プレビュー（モックアップ）</h6>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="mt-6 pt-4 border-t border-gray-300">
                      <h6 className="text-md font-semibold text-gray-900 mb-3">Instagram特有のメトリクス</h6>
