            ...
            >
              <div className="flex items-center space-x-4 flex-1">
                ...
                <div className="flex-1">
                  <h4 className="text-sm font-medium text-gray-900 truncate">{item.adName}</h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                  ...
                  <div className="bg-white rounded-lg p-4">
                    ...
                    <MetricRow
                      ...
                      value={
                        item.metrics.frequency > 0
                          ? ((1 / item.metrics.frequency) * 100).toFixed(1)
                          : '0'
                      }
                      unit="%"
                      thresholdStatus={
                        item.metrics.frequency > 2
                          ? 'danger'
                          : item.metrics.frequency > 1.5
                            ? 'warning'
                            : 'safe'
                      }
                  ...
                  <div className="mt-4">
                    <h5 className="text-sm font-semibold text-gray-700 mb-3">疲労度分析</h5>
                    <div className="grid grid-cols-3 gap-3">
                      <div className="text-center p-3 bg-gray-50 rounded">
                        ...
                        <div
                          className={`text-2xl font-bold ${getCtrStatus(item.metrics.ctr) === 'danger' ? 'text-red-600' : 'text-gray-600'}`}
                        >
                      ...
                      <div className="text-center p-3 bg-gray-50 rounded">
                        ...
                        <div
                          className={`text-2xl font-bold ${getFrequencyStatus(item.metrics.frequency) === 'danger' ? 'text-red-600' : 'text-gray-600'}`}
                        >
                      ...
                      <div className="text-center p-3 bg-gray-50 rounded">
                        ...
                        <div
                          className={`text-2xl font-bold ${getCpmStatus(item.metrics.cpm) === 'danger' ? 'text-red-600' : 'text-gray-600'}`}
                        >
