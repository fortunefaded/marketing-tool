...
export const ECForceDashboard: React.FC<ECForceDashboardProps> = ({ orders }) => {
  const { optimizeAggregatedData, optimizeChartData, getCachedData, setCachedData } =
  ...
  const kpis = useMemo(() => {
    ...
    const subscriptionRate =
      (filteredOrders.filter((order) => order.定期ステータス === '有効').length /
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center py-12">
          ...
          <p className="mt-1 text-sm text-gray-500">EC Forceからデータをインポートしてください</p>
          <div className="mt-6">
            <a
              href="/ecforce-import"
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600">売上データと顧客分析の概要</p>
          </div>
          <AddToFavoriteButton
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between">
          <ECForceDateFilter dateRange={dateRange} onDateRangeChange={setDateRange} />
          <button
      ...
      {/* KPIカード */}
      <div className="mb-8">
        {isProcessing ? <KPICardSkeleton /> : <ECForceKPICards kpis={kpis} />}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        {isProcessing ? (
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">顧客分析</h2>
      ...
      {isProcessing ? (
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">オファー別分析</h2>
