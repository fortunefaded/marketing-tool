...
export function GoogleAdsAPIReference() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Google Ads API v21 リファレンス</h1>
        <p className="text-gray-600">
          Google Ads APIから取得可能なデータフィールドの完全リファレンス
        </p>
      </div>
...
ORDER BY metrics.impressions DESC`}
          ...
          <div>
            <p className="text-sm text-gray-600 mb-2">広告グループ別のパフォーマンス：</p>
            <pre className="bg-gray-900 text-green-400 p-4 rounded-lg overflow-x-auto text-sm">
{`SELECT
  ad_group.name,
  ad_group.campaign,
